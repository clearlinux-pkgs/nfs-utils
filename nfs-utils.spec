...
%prep
%setup -q -n nfs-utils-2.4.3
cd %{_builddir}/nfs-utils-2.4.3
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
cp %{_builddir}/nfs-utils-2.4.3/support/nfsidmap/COPYING %{buildroot}/usr/share/package-licenses/nfs-utils/82c1cadc8c3bb346234c740b2b77c7d607b8f9ac
cp %{_builddir}/nfs-utils-2.4.3/utils/statd/COPYING %{buildroot}/usr/share/package-licenses/nfs-utils/74a8a6531a42e124df07ab5599aad63870fa0bd4
%make_install
