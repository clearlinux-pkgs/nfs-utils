...
Source0  : https://sourceforge.net/projects/nfs/files/nfs-utils/2.5.4/nfs-utils-2.5.4.tar.xz
...
%prep
%setup -q -n nfs-utils-2.5.4
cd %{_builddir}/nfs-utils-2.5.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623795255
...
cp %{_builddir}/nfs-utils-2.5.4/COPYING %{buildroot}/usr/share/package-licenses/nfs-utils/60457201edeb887de11bf46b66fc02494d08ef4d
cp %{_builddir}/nfs-utils-2.5.4/support/nfsidmap/COPYING %{buildroot}/usr/share/package-licenses/nfs-utils/82c1cadc8c3bb346234c740b2b77c7d607b8f9ac
cp %{_builddir}/nfs-utils-2.5.4/utils/statd/COPYING %{buildroot}/usr/share/package-licenses/nfs-utils/74a8a6531a42e124df07ab5599aad63870fa0bd4
%make_install
